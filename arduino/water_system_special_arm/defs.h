...
#define LINEAR_TRACK_REWARDS (2)
#define REWARDS_FOR_ARM (5)
#define MAXIMUM_TRACE_LENGTH (400)
#define BAUD_RATE (9600)

#define BEAM_BREAK_SAMPLE_WINDOW (5)
#define BEAM_BREAK_SAMPLE_PAUSE (10)

// Positions 0, 1 are used for the linear track.
// Position 2 is for the extra arm.
